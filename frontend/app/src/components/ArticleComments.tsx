...
const emoji = ["👍", "❤️", "🔥", "😂"];
type ArticleProps = { article: ApiPost; onBack: () => void; onError: (message: string) => void; onOpenProfile: (userId: number) => void };

export function ArticleComments({ article, onBack, onError, onOpenProfile }: ArticleProps) {
