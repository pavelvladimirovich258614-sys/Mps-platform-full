...
const emoji = ["👍", "❤️", "🔥", "😂"];
type ArticleProps = { article: ApiPost; commentsModerationEnabled?: boolean; onBack: () => void; onError: (message: string) => void; onOpenProfile: (userId: number) => void };

export function ArticleComments({ article, commentsModerationEnabled = false, onBack, onError, onOpenProfile }: ArticleProps) {
