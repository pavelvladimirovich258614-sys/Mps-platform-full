...
export function Drafts({ drafts, loading, onOpen, onDelete }: { drafts: DraftSummary[]; loading: boolean; onOpen: (draft: DraftSummary) => void; onDelete: (draft: DraftSummary) => Promise<void> }) {
