...
export function Legal({ kind, onBack }: { kind: LegalKind; onBack: () => void }) { const page = legal[kind]; return <main className="legal-page"><button className="back-link" onClick={onBack}>← В ленту</button><h1>{page.title}</h1><p>{page.body}</p></main>; }
