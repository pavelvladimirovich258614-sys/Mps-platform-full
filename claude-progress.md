...
- Next best action: plan F37 Session B — the user fishka creation form — separately. Do not change Unisender transport without a separate decision: the external network blocker remains separate.
