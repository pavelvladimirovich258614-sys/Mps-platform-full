...
- Next best action: continue F36 Package 4 (forum naming) after a confirmed plan. Do not change Unisender transport without a separate decision: the external network blocker remains separate.
