...
- Next best action: read-only diagnose slow personal-profile loading before proposing any performance change. Do not change Unisender transport without a separate decision: the external network blocker remains separate.
