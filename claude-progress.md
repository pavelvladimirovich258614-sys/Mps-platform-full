...
- Next best action: отдельное approval Павла на production rollout F29 frontend; после deploy подтвердить в живой Telegram-сессии HEIC/HEIF avatar upload и повторный выбор одного файла. Не менять Unisender transport без отдельного решения: внешний сетевой блокер остаётся отдельно.
