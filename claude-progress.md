...
- Next best action: начать отдельно согласованную публичную страницу профиля; параллельно открыть тикет HostKey по selective egress timeout к Unisender и отдельно решить SMTP/alternate provider, если маршрут не восстановят.
