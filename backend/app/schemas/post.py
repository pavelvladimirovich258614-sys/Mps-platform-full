...
class PostWrite(BaseModel):
    type: PostType; title: str = Field(min_length=1,max_length=255); body: str; excerpt: str=""; status: PostStatus=PostStatus.DRAFT; cover_url: str|None=None; cta_enabled: bool=True; video_url: str|None=None; hotel_name: str|None=None; country_id: int|None=None; shot_at: date|None=None; by_request: bool=False
