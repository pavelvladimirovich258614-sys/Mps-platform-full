# Session handoff — после F10

## Verified state
- F01–F10 passing; Alembic head `20260818_0007`; full pytest and `./init.sh`: 37 passed. Код готов к production deploy.
...
- После deploy: `BASE_URL=https://REAL_DOMAIN POST_SLUG=REAL_POST_SLUG deploy/smoke.sh`, проверить `/var/backups/mps/`, systemd status, DNS/certbot и зарегистрировать sitemap в Яндекс.Вебмастер/GSC.
